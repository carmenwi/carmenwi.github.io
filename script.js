...
const I18N = {
  en: {
    ...
    "cs1.r": "All of it: idea, architecture, OpenAI integration, UX and deployment — one person against the hackathon clock, with Git discipline as if it were a team repo.",
    ...
    "cs1.a": "MyLEA: a hub that connects to university virtual campuses and centralizes studying. AI-generated study paths and summaries via the OpenAI API, plus a virtual pet that gamifies staying on track. Python + Streamlit, built entirely solo — from concept to MVP deployed on Streamlit Cloud.",
    "cs1.i": "1st Place Innovation Award at Hack4Edu 2025, Iberoamerica's largest edtech hackathon (ProFuturo — Telefónica & \"la Caixa\") — one person, competing against full teams worldwide.",
    ...
    "p1.desc": "A platform that plugs into university virtual campuses and turns scattered coursework into one organized study hub — with AI study paths, summaries and a virtual pet that keeps motivation alive. Built solo, end to end, and judged 1st for Innovation against full teams worldwide (ProFuturo — Telefónica & \"la Caixa\").",
  ...
  es: {
    ...
    "cs1.r": "Todo: idea, arquitectura, integración con OpenAI, UX y despliegue — una sola persona contra el reloj del hackathon, con disciplina de Git como si fuera un repo de equipo.",
    ...
    "cs1.a": "MyLEA: un hub que se conecta a los campus virtuales y centraliza el estudio. Rutas de estudio y resúmenes generados con IA (API de OpenAI), más una mascota virtual que gamifica la constancia. Python + Streamlit, construida completamente en solitario — del concepto al MVP desplegado en Streamlit Cloud.",
    "cs1.i": "1er Premio a la Innovación en Hack4Edu 2025, el mayor hackathon edtech de Iberoamérica (ProFuturo — Telefónica y \"la Caixa\") — una sola persona compitiendo contra equipos completos de todo el mundo.",
    ...
    "p1.desc": "Una plataforma que se conecta a los campus virtuales y convierte el caos de asignaturas en un centro de estudio organizado — con rutas de estudio por IA, resúmenes y una mascota virtual que mantiene viva la motivación. Construida en solitario de principio a fin, y 1er Premio a la Innovación frente a equipos completos de todo el mundo (ProFuturo — Telefónica y \"la Caixa\").",
